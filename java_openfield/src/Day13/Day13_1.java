...
public class Day13_1 {	
	...
	public static void main(String[] args) {
		...
		System.out.println("변환 후 : " + 문자열);
		
		byte[] 바이트배열2 = { 97, 93, 82 , 127, 32 };
		String 문자열2 = new String(바이트배열2);
		System.out.println("변환 후 : " + 문자열2);
		
		
		byte[] 바이트배열3 = { 72, 101, 108, 108, 111, 32, 74, 97, 118, 97};
		String 문자열3 = new String(바이트배열3);
		System.out.println("변환 후 : " + 문자열3);
		
		String 문자열4 = new String(바이트배열3, 6, 4);
		System.out.println("일부 변환 후 :"+문자열4);
		...
		if(문자열7.equals(문자열8)) {System.out.println("두 문자는 ==");}
		...
		System.out.println("변환 : " + 문자열10);
			...
			try {
				byte[] 바이트배열6 = 문자열9.getBytes("euc-kr");
				System.out.println("euc-kr 길이 : " + 바이트배열6.length);
				
				byte[] 바이트배열7 = 문자열9.getBytes("utf-8");
