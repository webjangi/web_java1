...
public class Day07_1 {
	...
	// 예1) 반복문을 이용한 0~99까지 int형의 배열에 각 인덱스에 저장하고 출력
		//1. 배열 선언
	    ...
	    System.out.println("2차원 배열 [2행,1열] : " + 배열2[1][1]);
	    System.out.println("2차원 배열 [2행,1열] : " + 배열2[1][2]);
	    ...
	    int[][] 배열4 = new int [2][50];
	    	...
	    	//0~49
	    			...
	    			else 배려4[1][i]=i; //50~99
	    		}
	    
	
	    		//3차원
	    		int [][][] 배열5 = new int [2][3][3]; // 가로,세로, 높이 = 2*3*3* = 18
